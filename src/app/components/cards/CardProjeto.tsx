...
export default function CardProjeto(props: PropsCardProjeto) {
  ...
  return (
    <>
      <div className="flex flex-col justify-between items-center shadow-lg bg-[var(--corFundo)] text-center p-2  md:p-4 my-5 md:min-w-[45vw] md:min-h-[380px] lg:min-h-[575px] ">
        ...
        <div className="flex flex-col justify-between items-center md:w-[100%] ">
          ...
          <div className="bg-[var(--opacitySucess)] p-2 md:p-4 flex flex-col justify-between items-center shadow-md hover:scale-105  hover:bg-[var(--opacityError)] rounded-md min-h-[16vh] min-w-[29vw] md:min-h-[19vw] lg:min-h-[23vh] lg:min-w-[9vw]  md:w-[33%]">
            <h3 className="text-[var(--base)] text-[1rem] md:text-[1.3rem] lg:text-[1rem] md:my-2 ">
               {props.tec1}
            </h3>
