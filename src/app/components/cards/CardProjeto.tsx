        ...
        <div className="flex flex-col justify-between items-center md:w-[100%] ">
          <div className="flex flex-col md:flex md:justify-around items-center md:my-4 md:gap-2 md:w-[100%]">
            <div className="w-full lg:w-[50%]">
              <h3 className="text-[var(--base)]  md:my-2 md:text-[1.5rem] my-2">
                {props.nome}
              </h3>
              <p className="text-[var(--base)] md:text-[1.4rem] my-2 ">
                {props.descrição}
              </p>
            </div>
          ...
          <div className="bg-[var(--opacitySucess)] p-2 md:p-4 flex flex-col justify-between items-center shadow-md hover:scale-105  hover:bg-[var(--opacityError)] rounded-md min-h-[15vh] md:w-[33%]">
