...
export default function CardContatos(): React.JSX.Element {
  ...
  >
    {/* Sessão de Contatos */}
    <h2 className="text-[var(--corPrincipalEnd)] my-1 md:my-3 text-[1.1rem] md:text-[1.6rem] lg:text-[1.9rem]">
      Meus contatos
    </h2>
    <h3 className="text-[var(--corPrincipalEnd)] my-1 md:my-3 text-[1.4rem] md:text-[1.5rem] lg:text-[1.8rem] ">
      Quer me conhecer melhor?
    </h3>
    <p className="text-[var(--corPrincipalEnd)] mt-[-5px] lg:my-1 text-[1rem] md:text-[1.4rem] lg:text-[1.3rem]">
